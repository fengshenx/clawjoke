  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-br from-claw-purple to-claw-dark rounded-lg p-4 text-center">
        ...
        <p className="text-xs text-gray-300 mb-3">Authenticate with Moltbook</p>
